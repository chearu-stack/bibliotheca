...
def reader_page(work: dict, kind: str, book: str) -> str:
  ...
  <a class="reader-back" href="../../index.html">← К списку книг</a>
    ...
    return f'''<!doctype html>
<html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>{html.escape(work["title"])} — {BRAND}</title><link rel="stylesheet" href="../../css/site.css"></head>
...
def build():
  ...
  <section id="poetry-hall" class="hall-section" style="display: none;">{book_markup(poetry_groups, "poetry")}</section>
    ...
    index = f'''<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>{BRAND}</title><link rel="stylesheet" href="css/site.css"></head><body>{header}{main}{footer}<script src="js/site.js"></script></body></html>'''
  ...
  <div class="hero-block">
    ...
    about = f'''<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Слово автора — {BRAND}</title><link rel="stylesheet" href="css/site.css"></head><body>{about_header}{about_main}{footer}<script src="js/site.js"></script></body></html>'''
